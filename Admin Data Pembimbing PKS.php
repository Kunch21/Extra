...
$pembimbing_pks = query("SELECT * FROM pembimbing_pks");

// cek apakah tombil submit sudah ditekan atau belum
if( isset($_POST["submit"]) ) {

    // cek apakah data berhasil ditambahkan atau tidak
    if ( addpempks($_POST) > 0 ) {
        echo "
            <script>
...
<body>
    ...
    <div class="divform">
        <h1>Tambah Data Pembimbing PKS</h1>
    ...
    <table class="table">
        ...
        <tbody>
            <?php $i = 1; ?>
            <?php foreach( $pembimbing_pks as $row ) : ?>
            <tr>
                <td><?= $i; ?></td>
                <td>
                    <a href="Update Data Pembimbing PKS.php?id=<?= $row["id_pemb"]; ?>">Update</a> | 
                    <a href="Delete Data Pembimbing PKS.php?id=<?= $row["id_pemb"];  ?>" onclick="
