...
$pembimbing_pks = mysqli_query($conn, "SELECT * FROM pembimbing_pks");
?>
...
<head>
    ...
    <title>Pembibing PKS SMKN 1 Bantul</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
      <ul class="navbar-nav">
		...
		<li class="nav-item dropdown">
			...
			<ul class="dropdown-menu">
				<li><a class="dropdown-item active" href="Pembimbing PKS page.php">PKS</a></li>
    ...
    <div class="backpembpks">
        <div class="imgpemb"><img src="photo/<?= $row["image"]; ?>"></div>
        <div class="txtpembpks">
            <h1><?= $row["nama"]; ?></h1>
            <h3>Pembina PKS SMK N 1 Bantul</h3>
        </div>
    </div>

    <div class="contpembpks">
        <h3>About</h3>
