...
$jadwal_pramuka = query("SELECT * FROM jadwal_pramuka");
...
<head>
    ...
    <title>Data Jadwal Kegiatan Pramuka</title>
</head>
<body>
    ...
    <div class="divform">
        <h1>Tambah Data Jadwal Kegiatan Pramuka</h1>
    ...
    <h1>Data Jadwal Kegiatan Pramuka</h1>
    <br>
    <table class="table">
        <thead>
            <tr>
        ...
        <tbody>
            <?php $i = 1; ?>
            <?php foreach( $jadwal_pramuka as $row ) : ?>
            <tr>
                <td><?= $i; ?></td>
                <td>
                    <a href="Update Data Jadwal Pramuka.php?id=<?= $row["id_keg"]; ?>">Update</a> | 
                    <a href="Delete Data Jadwal Pramuka.php?id=<?= $row["id_keg"]; ?>" onclick="
