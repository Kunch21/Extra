...
$event_kkr = query("SELECT * FROM event_kkr");
...
<body>
    ...
    <table class="table">
        ...
        <tbody>
            <?php $i = 1; ?>
            <?php foreach( $event_kkr as $row ) : ?>
            <tr>
                <td><?= $i; ?></td>
                <td>
                    <a href="Update Data Event KKR.php?id=<?= $row["id"]; ?>">Update</a> | 
                    <a href="Delete Data Event KKR.php?id=<?= $row["id"];  ?>" onclick="
