...
$pengurus_kkr = query("SELECT * FROM pengurus_kkr");
...
<body>
    ...
    <div class="divform">
        <h1>Tambah Data Pengurus/Anggota KKR</h1>
    ...
    <h1>Data Pengurus/Anggota KKR</h1>
    <br>
    <table class="table">
        <thead>
            <tr>
        ...
        <tbody>
            <?php $i = 1; ?>
            <?php foreach( $pengurus_kkr as $row ) : ?>
            <tr>
                <td><?= $i; ?></td>
                <td>
                    <a href="Update Data Pengurus KKR.php?id=<?= $row["id_pgrs"]; ?>">Update</a> | 
                    <a href="Delete Data Pengurus KKR.php?id=<?= $row["id_pgrs"]; ?>" onclick="
