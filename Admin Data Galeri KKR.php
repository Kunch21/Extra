...
$galeri_kkr = query("SELECT * FROM galeri_kkr");
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                <td><?= $i; ?></td>
                <td>
                    <a href="Update Data Galeri KKR.php?id=<?= $row["id_glri"]; ?>">Update</a> | 
                    <a href="Delete Data Galeri KKR.php?id=<?= $row["id_glri"]; ?>" onclick="
