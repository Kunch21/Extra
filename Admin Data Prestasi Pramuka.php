...
$prestasi_pra = query("SELECT * FROM prestasi_pramuka");

// cek apakah tombil submit sudah ditekan atau belum
if( isset($_POST["submit"]) ) {

    // cek apakah data berhasil ditambahkan atau tidak
    if ( addprespra($_POST) > 0 ) {
        echo "
            <script>
...
<body>
    ...
    <div class="divform">
        <h1>Tambah Data Prestasi Pramuka</h1>
    ...
    <table class="table">
        ...
        <tbody>
            <?php $i = 1; ?>
            <?php foreach( $prestasi_pra as $row ) : ?>
            <tr>
                <td><?= $i; ?></td>
                <td>
                    <a href="Update Data Prestasi Pramuka.php?id=<?= $row["id_pres"]; ?>">Update</a> | 
                    <a href="Delete Data Prestasi Pramuka.php?id=<?= $row["id_pres"]; ?>" onclick="
