...
$pembimbing_kkr = mysqli_query($conn, "SELECT * FROM pembimbing_kkr");
?>
...
<body>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item active" href="Pembimbing KKR page.php">KKR</a></li>
    ...
    <div class="backpembkkr">
        <div class="imgpemb"><img src="photo/<?= $row["image"]; ?>"></div>
        <div class="txtpembkkr">
            <h1><?= $row["nama"]; ?></h1>
            <h3>Pembina KKR SMK N 1 Bantul</h3>
        </div>
    </div>

    <div class="contpembkkr">
        <h3>About</h3>
