...
$pembimbing_kkr = query("SELECT * FROM pembimbing_kkr");

// cek apakah tombil submit sudah ditekan atau belum
if( isset($_POST["submit"]) ) {

    // cek apakah data berhasil ditambahkan atau tidak
    if ( addpemkkr($_POST) > 0 ) {
        echo "
            <script>
...
<body>
    ...
    <div class="divform">
        <h1>Tambah Data Pembimbing KKR</h1>
    ...
    <table class="table">
        ...
        <tbody>
            <?php $i = 1; ?>
            <?php foreach( $pembimbing_kkr as $row ) : ?>
            <tr>
                <td><?= $i; ?></td>
                <td>
                    <a href="Update Data Pembimbing KKR.php?id=<?= $row["id_pemb"]; ?>">Update</a> | 
                    <a href="Delete Data Pembimbing KKR.php?id=<?= $row["id_pemb"];  ?>" onclick="
