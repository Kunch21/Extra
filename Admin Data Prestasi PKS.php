...
$prestasi_pks = query("SELECT * FROM prestasi_pks");

// cek apakah tombil submit sudah ditekan atau belum
if( isset($_POST["submit"]) ) {

    // cek apakah data berhasil ditambahkan atau tidak
    if ( addprespks($_POST) > 0 ) {
        echo "
            <script>
...
<body>
    ...
    <div class="divform">
        <h1>Tambah Data Prestasi PKS</h1>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                <td><?= $i; ?></td>
                <td>
                    <a href="Update Data Prestasi PKS.php?id=<?= $row["id_pres"]; ?>">Update</a> | 
                    <a href="Delete Data Prestasi PKS.php?id=<?= $row["id_pres"]; ?>" onclick="
