...
$prestasi_kkr = mysqli_query($conn, "SELECT * FROM prestasi_kkr");
?>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
  <div class="container-fluid">
    ...
    <h1 class="preskkrj">PRESTASI KKR</h1>
    <div class="preskkrjline"></div>
    <div class="preskkrj1"><h5>Berikut merupakan prestasi yang telah diraih oleh ekstrakulikuler KKR dari SMK Negri 1 Bantul</h5></div>

    <?php foreach( $prestasi_kkr as $row ) : ?>
    <div class="prestasikkr">
        <img src="photo/<?= $row["image"]; ?>" alt="">
        <div class="reddiv">
            <h4><?= $row["prestasi"]; ?> Tingkat <?= $row["tingkat"]; ?></h4>
        </div>
        <div class="prestasikkrline"></div>
        <div class="txtpreskkr">
            <h5><?= $row["tanggal"]; ?></h5>
            <div class="txtpreskkrline"></div>
            <p><?= $row["deskripsi"]; ?></p>
            <div class="juarapreskkr">
