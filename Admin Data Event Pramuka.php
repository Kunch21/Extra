...
$event_pra = query("SELECT * FROM event_pramuka");
...
<body>
    ...
    <div class="divform">
        <h1>Tambah Data Event Pramuka</h1>
    ...
    <table class="table">
        ...
        <tbody>
            <?php $i = 1; ?>
            <?php foreach( $event_pra as $row ) : ?>
            <tr>
                <td><?= $i; ?></td>
                <td>
                    <a href="Update Data Event Pramuka.php?id=<?= $row["id"]; ?>">Update</a> | 
                    <a href="Delete Data Event Pramuka.php?id=<?= $row["id"];  ?>" onclick="
