...
$jadwal_pks = query("SELECT * FROM jadwal_pks");
...
<head>
    ...
    <title>Data Jadwal Kegiatan PKS</title>
</head>
<body>
    ...
    <div class="divform">
        <h1>Tambah Data Jadwal Kegiatan PKS</h1>
    ...
    <h1>Data Jadwal Kegiatan PKS</h1>
    <br>
    <table class="table">
        <thead>
            <tr>
        ...
        <tbody>
            <?php $i = 1; ?>
            <?php foreach( $jadwal_pks as $row ) : ?>
            <tr>
                <td><?= $i; ?></td>
                <td>
                    <a href="Update Data Jadwal PKS.php?id=<?= $row["id_keg"]; ?>">Update</a> | 
                    <a href="Delete Data Jadwal PKS.php?id=<?= $row["id_keg"]; ?>" onclick="
