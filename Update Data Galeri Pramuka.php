...
// query data galeri_pra berdasarkan id
$gpra = query("SELECT * FROM galeri_pramuka WHERE id_glri = $id")[0];

// cek apakah tombil submit sudah ditekan atau belum
if( isset($_POST["submit"]) ) {

    // cek apakah data berhasil ditambahkan atau tidak
    if ( updategpra($_POST) > 0 ) {
        echo "
            <script>
...
<a href="Index Admin.php"><img class="imgIndexAdmin" src="photo/home-icon.png"></a>
    ...
    <div class="divform">
        <h1>Update Data Galeri Pramuka</h1>
        <form action="" method="post" enctype="multipart/form-data">
            <input type="hidden" name="id" value="<?= $gpra["id_glri"]; ?>">
            <input type="hidden" name="oldimage" value="<?= $gpra["image"]; ?>">
            <div class="mb-3">
                <label for="image" class="form-label">Image</label>
                <img src="photo/<?= $gpra["image"]; ?>" width="50">
