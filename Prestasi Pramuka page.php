...
$prestasi_pramuka = mysqli_query($conn, "SELECT * FROM prestasi_pks");
...
<head>
    ...
    <title>Prestasi KKR SMKN 1 Bantul</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
  <div class="container-fluid">
      ...
      <ul class="navbar-nav">
		...
		<li class="nav-item dropdown">
			...
			<ul class="dropdown-menu">
				...
				<li><a class="dropdown-item active" href="Prestasi Pramuka page.php">PRAMUKA</a></li>
			</ul>
        </li>
		<li class="nav-item dropdown">
			<a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    <h1 class="prespraj">PRESTASI PRAMUKA</h1>
    <div class="presprajline"></div>
    <div class="prespraj1"><h5>Berikut merupakan prestasi yang telah diraih oleh ekstrakulikuler Pramuka dari SMK Negri 1 Bantul</h5></div>

    <?php foreach( $prestasi_pramuka as $row ) : ?>
    <div class="prestasipra">
        <img src="photo/<?= $row["image"]; ?>" alt="">
        <div class="browndiv">
            <h4><?= $row["prestasi"]; ?> Tingkat <?= $row["tingkat"]; ?></h4>
        </div>
        <div class="prestasipraline"></div>
        <div class="txtprespra">
            <h5><?= $row["tanggal"]; ?></h5>
            <div class="txtprespraline"></div>
            <p><?= $row["deskripsi"]; ?></p>
            <div class="juaraprespra">
